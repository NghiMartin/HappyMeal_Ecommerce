  ...
  return (
    <>
      ...
      <div className="container my-3 py-3">
        ...
        “Happy Meals” hướng tới nâng cao chất lượng cuộc sống bằng những bữa ăn dinh dưỡng, tự nhiên và không hóa chất. Chúng tôi muốn xây dựng cộng đồng sống khỏe mạnh, nơi thực phẩm sạch là tiêu chuẩn hàng đầu, mang lại sự an tâm và hạnh phúc cho khách hàng.
        </p>
